export const SOCIAL_CACHE_TTL_MS = Number(process.env.SOCIAL_CACHE_TTL_MS || 60_000);
...
export const SOCIAL_YT_DLP_TIMEOUT_MS = Number(process.env.SOCIAL_YT_DLP_TIMEOUT_MS || 15_000);
...
export const SOCIAL_OPENAI_TIMEOUT_MS = Number(process.env.SOCIAL_OPENAI_TIMEOUT_MS || 12_000);
