...
function parseAlternatives(raw) {
    ...
    if (parenOr?.[1])
        alternatives.push(parenOr[1].trim());
    return alternatives;
}
...
export function parseIngredientDetail(rawInput) {
...
export function parseIngredientDetails(ingredients) {
    return ingredients.map((raw) => parseIngredientDetail(raw));
}
//# sourceMappingURL=ingredientDetailParser.js.map