...
export const CACHE_TTL_MS = Number(process.env.EXTRACTION_CACHE_TTL_MS || 60000);
export const CACHE_MAX_ENTRIES = Number(process.env.EXTRACTION_CACHE_MAX_ENTRIES || 500);
export const NEGATIVE_CACHE_TTL_MS = Number(process.env.NEGATIVE_CACHE_TTL_MS || 120000);
export const NEGATIVE_CACHE_MAX_ENTRIES = Number(process.env.NEGATIVE_CACHE_MAX_ENTRIES || 1000);
export const DOMAIN_BLOCK_COOLDOWN_MS = Number(process.env.DOMAIN_BLOCK_COOLDOWN_MS || 60000);
export const DOMAIN_BLOCK_CONSECUTIVE_403_THRESHOLD = Number(process.env.DOMAIN_BLOCK_CONSECUTIVE_403_THRESHOLD || 2);
